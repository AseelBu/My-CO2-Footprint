...
//
//public class FoodListAdapter extends ArrayAdapter<Food2> {
//    private static final int REQ_CODE = 123;
//    private DataHolder dh = DataHolder.getInstance();
//    private List<Food2> dataList = null;
//    private Context context = null;
//    public FoodListAdapter(Context context, List<Food2> dataList) {
//        super(context, R.layout.food_list, dataList);
//        this.dataList = dataList;
//        this.dataList.add(0,new Food2());
...
//    }
//    @Override
//    public Food2 getItem(int position)
//    {
...
//            final Food2 itemInfo = dataList.get(position);
